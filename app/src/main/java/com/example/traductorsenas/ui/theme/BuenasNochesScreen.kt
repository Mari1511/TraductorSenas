...
@Composable
fun BuenasNochesScreen(navController: NavController) {
    ...
    val exoPlayer = remember {
        ExoPlayer.Builder(context).build().apply {
            ...
            val mediaItem = MediaItem.fromUri("android.resource://${context.packageName}/${R.raw.buenasnoches}")
