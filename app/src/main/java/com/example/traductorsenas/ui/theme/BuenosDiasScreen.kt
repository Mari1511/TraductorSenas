package com.example.traductorsenas.ui.theme
...
import com.example.traductorsenas.R

@OptIn(ExperimentalMaterial3Api::class)
@Composable
fun BuenosDiasScreen(navController: NavController) {
    ...
    val exoPlayer = remember {
        ExoPlayer.Builder(context).build().apply {
            ...
            val mediaItem = MediaItem.fromUri("android.resource://${context.packageName}/${R.raw.buenosdias}")
